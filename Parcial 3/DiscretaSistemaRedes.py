...
class progra5: # Función para simular el proceso de un paquete
    ...
    def run_simulation(capacidad_servidor, capacidad_cola, tiempo_llegadas, total_paquetes):
        ...
        if paquetes_procesados > 0:
            ...
            tiempo_promedio_espera = float(tiempo_total_espera / paquetes_procesados)
...
class Aplicacion:
    def __init__(self):        
        ...
        title = tk.Label(frame_form_top, text="Simulación de Servidor de Red", font=('Times', 30), fg="#666a88", bg='#fcfcfc', pady=10)
        ...
        start_button = tk.Button(frame_form, text="Iniciar Simulación", font=('Times', 15, 'bold'), bg='#3a7ff6', fg="#fff", command=self.start_simulation)
