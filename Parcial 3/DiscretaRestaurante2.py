...
class Aplicacion:
    def __init__(self):
        ...
        title = tk.Label(frame_form_top, text="Simulación de Restaurante", font=('Times', 30), fg="#666a88", bg='#fcfcfc', pady=20)
        ...
        start_button = tk.Button(frame_form_fill, text="Iniciar Simulación", font=('Times', 15), bg='#3a7ff6', bd=0, fg="#fff", command=self.start_simulation)
