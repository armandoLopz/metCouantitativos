...
class SimuladorEnfriamiento:
    def __init__(self):
        ...
        title = tk.Label(frame_form_top, text="Simulación de Enfriamiento de Reactor Nuclear", font=('Times', 30), fg="#666a88", bg='#fcfcfc', pady=50)
        ...
        button_run = tk.Button(frame_form_fill, text="Ejecutar Simulación", font=('Times', 15, 'bold'), bg='#3a7ff6', bd=0, fg="#fff", command=self.run_simulation)
