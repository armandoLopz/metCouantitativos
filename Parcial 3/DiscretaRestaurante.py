...
class SimulationApp:
    ...
    def setup_gui(self):
        ...
        title = tk.Label(frame_top, text="Simulador de Restaurante", font=('Times', 30), fg="#666a88", bg='#fcfcfc', pady=50)
        ...
        start_button = tk.Button(frame_form, text="Iniciar Simulación", font=('Times', 15, 'bold'), bg='#3a7ff6', bd=0, fg="#fff", command=start_simulation)
