...
class SimuladorDescomposicion:
    def __init__(self):
        ...
        title = tk.Label(frame_form_top, text="Simulador de Descomposición de Reactivo", font=('Times', 20), fg="#666a88", bg='#fcfcfc', pady=50)
        ...
        boton_simular = tk.Button(frame_form_fill, text="Simular", font=('Times', 15, 'bold'), bg='#3a7ff6', bd=0, fg="#fff", command=self.simular)
