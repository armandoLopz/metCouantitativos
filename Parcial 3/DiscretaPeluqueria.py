...
class SimuladorPeluqueria:
    def __init__(self):
        ...
        title = tk.Label(frame_form_top, text="Simulación de Peluquería", font=('Times', 30), fg="#666a88", bg='#fcfcfc', pady=50)
        ...
        btn_simular = tk.Button(frame_form_fill, text="Ejecutar Simulación", font=('Times', 15, 'bold'), bg='#3a7ff6', bd=0, fg="#fff", command=self.ejecutar_simulacion)
